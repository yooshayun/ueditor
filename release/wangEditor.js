...
SplitLine.prototype = {
    ...
    _createinsertDom: function _createinsertDom() {
        var editor = this.editor;
        var html = '<div class="split"></div><p><br></p>';
