...
import UploadAudio from './upload/upload-audio.js'
...
Editor.prototype = {
    ...
    _initDom: function () {
        ...
        if (textSelector == null) {
            ...
            // 自行创建的，需要配置默认的样式
            $toolbarElem.css('background-color', '#fff')
                        .css('border-top', '1px solid rgba(238,238,238,1)')
                        .css('border-bottom', '1px solid rgba(238,238,238,1)')
        } else {
